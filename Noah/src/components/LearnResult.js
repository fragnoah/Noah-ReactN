 ...
 * hier muss noch geklärt werden, ob überhaupt gebraucht wird
 * falls ja: hinzufügen Repeat-Pages und Anpassung ALLER States und Redux-Methoden für Learn-Store!
 */
...
class Result extends Component {
    checkScore() {
        ...
        if (this.props.quiz.learnbasisScore >= 5 && this.props.quiz.learnspezScore >= 18) {
