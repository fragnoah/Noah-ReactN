...
/**
 * Wiederholungsseite für falsche Fragen
...
class RepeatPage extends Component {
    ...
    renderContent() {
       let highlight = ['abc'];
       switch (this.arrnew[this.antworten[this.state.qno]].highlightWords[0]) {
           case 'option1':
               highlight[0] = this.arrnew[this.antworten[this.state.qno]].options.option1;
               break;
           case 'option2':
               highlight[0] = this.arrnew[this.antworten[this.state.qno]].options.option2;
               break;
           case 'option3':
               highlight[0] = this.arrnew[this.antworten[this.state.qno]].options.option3;
               break;
           case 'option4':
               highlight[0] = this.arrnew[this.antworten[this.state.qno]].options.option4;
               break;
           default:
               highlight = this.arrnew[this.antworten[this.state.qno]].highlightWords;
        }  

        const radioProps = [ 
            { label: (this.state.lighted === true &&
                this.arrnew[this.antworten[this.state.qno]].options.option1.includes(highlight) ? 
                <Highlighter
                ...
                value: 'option1' },
            { label: (this.state.lighted === true &&
                this.arrnew[this.antworten[this.state.qno]].options.option2.includes(highlight) ?  
                <Highlighter
                    highlightStyle={highlighter.lighted}
                    searchWords={[highlight.toString()]}
                ...
                value: 'option2' },
            { label: (this.state.lighted === true &&
                this.arrnew[this.antworten[this.state.qno]].options.option3.includes(highlight) ?  
                <Highlighter
                    highlightStyle={highlighter.lighted}
                    searchWords={[highlight.toString()]}
                ...
                /> : this.arrnew[this.antworten[this.state.qno]].options.option3),
                 value: 'option3' },
            { label: (this.state.lighted === true &&
                this.arrnew[this.antworten[this.state.qno]].options.option4.includes(highlight) ?  
                <Highlighter
                    highlightStyle={highlighter.lighted}
                    searchWords={[highlight.toString()]}
